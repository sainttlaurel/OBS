    ...
    // constraint to check zero values
         ...
         echo "</script>";
                ...
                if($query){
                    ...
                    add_notification($conn, $sender, 'Money Sent Successfully', 
                        "You sent ₱" . number_format($amount, 2) . " to " . $receiver, 'success');
                    
                    add_notification($conn, $receiver, 'Money Received', 
                        "You received ₱" . number_format($amount, 2) . " from " . $sender, 'success');
