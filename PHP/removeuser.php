            ...
            <div class="row">
                ...
                ?>
                    <tr style="color : white;">
                        ...
                        <td class="py-2"><?php echo htmlspecialchars($rows['user_name']); ?></td>
                        <td class="py-2"><?php echo htmlspecialchars($rows['user_email']); ?></td>
                        <td class="py-2"><?php echo htmlspecialchars($rows['phone']); ?></td>
                        <td class="py-2">₱<?php echo number_format($rows['balance'], 2); ?></td>
                        <td><a href="removeuserrq.php?id=<?php echo $rows['id']; ?>" onclick="return confirm('Are you sure you want to delete this user?');"> <button type="button" class="btn btn-danger" style="border-radius:0%;">Remove</button></a></td> 
                    </tr>
                <?php
                        $cnt=$cnt+1;
                    }
